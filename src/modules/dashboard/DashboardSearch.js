...
const DashboardSearch = () => {
  ...
  return (
    <div className="relative z-50">
      <div className="bg-white rounded-full shadow-[10px_10px_20px_rgba(218,_213,_213,0.15)] p-2 w-full  flex items-center">
      ...
      {showSearch && (
        <div className="search-results w-full lg:w-[843px] bg-white absolute top-full left-0 z-50 translate-y-5 pb-6 rounded-3xl">
          <div className="flex items-center justify-between p-3 mb-5 bg-graySoft rounded-3xl">
          ...
          <div className="p-6 pb-0">
            <div className="flex flex-col p-6 mb-6 gap-y-5">
